...
public:
    ...
    FunctionDeclaration(bool isConst, bool isPublic, bool isPrivate, const std::string& name, const std::vector<Param>& parameters, const std::vector<Stmt>& body)
...
public:
    ...
    AssignmentExpr(const Expr& identifier, const Expr& value)
